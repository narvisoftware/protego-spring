...
public class PermitNothingPolicyRule2 extends SpringBeanPolicyRule<TenantAccessPermission, TestSecurityContext> {

  public PermitNothingPolicyRule2(TenantAccessPermission permission, TestSecurityContext securityContext) {
